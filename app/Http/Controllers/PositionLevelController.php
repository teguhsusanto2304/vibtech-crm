...
class PositionLevelController extends Controller
{
    ...
    {
        return view('position_level.list')->with('title', 'Position Levels')->with('breadcrumb', ['Home', 'Master Data', 'Position Level']);
    }
    ...
    {
        return view('position_level.form')->with('title', 'Create a New Position Level')->with('breadcrumb', ['Home', 'Master Data', 'Position Levels', 'Creat a New Position Level']);
    }
