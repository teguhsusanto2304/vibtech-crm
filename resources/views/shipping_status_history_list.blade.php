      ...
      <table class="table table-hover">
        <thead >
          <tr>
            ...
            <th><label class="font">Status</label> <i class="fas fa-sort-down sort-icon"></i></th>
        ...
        <tbody>
          <tr>
            ...
            <td><a href="{{ route('shipping-status-view',['id'=>'complete'])}}" class="btn btn-sm btn-primary">Update Order</a></td>
          </tr>
          <tr>
