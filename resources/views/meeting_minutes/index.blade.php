                ...
                <div class="row gy-4 {{ $title == 'Job Requisition Form' ? 'equal-height-cards' : '' }}">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="card text-center">
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">New Meeting Minutes</h5>
                                
                                    <a href="{{ route('v1.meeting-minutes.create') }}" class="btn btn_primary mt-auto">
                                        Create</a>
                   ...
                   @can('view-all-meeting-minute')
                    <div class="col-12 col-md-4">
                        <div class="card text-center">
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">All Meeting Minutes</h5>
