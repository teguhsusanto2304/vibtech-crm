...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1" style="margin-top: 2rem">
        ...
        <li class="menu-item">
            <a href="{{ route('dashboard') }}" class="menu-link  menu-toggle">
                <i class="menu-icon">
                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35.15 33.23">
                        ...
                        <path id="Path" class="cls-task" d="M1.27.7h32.6c.32,0,.57.26.58.57v11.51c0,.32-.26.57-.58.57H1.27c-.32,0-.57-.26-.57-.57V1.27c0-.32.26-.57.57-.57Z"/>
                        <path id="Path-2" class="cls-task" d="M1.27,19.88h32.6c.32,0,.57.26.58.57v11.51c0,.32-.26.57-.58.57H1.27c-.32,0-.57-.26-.57-.57v-11.51c0-.32.26-.57.57-.57Z"/>
                      </svg>
                </i>
            ...
            <ul class="menu-sub">
                <li class="no-bullet">
                    <a href="{{ route('v1.job-assignment-form') }}" class="menu-link">
                        <div class="text-truncate" data-i18n="Analytics">Job Requisition Form</div>
                    </a>
                </li>
                <li class="no-bullet">
                    <a href="{{ route('leave-application') }}" class="menu-link">
            ...
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon">
                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44.8 37.35">
                        ...
                        <path id="Path_2" data-name="Path 2" class="cls-marketing" d="M23.47,20.72s-.09.01-.14,0l-.1-.05c-4.65-2.28-9.6-3.91-14.7-4.83H2.57C1.15,15.84,0,14.68,0,13.26c0-.01,0-.02,0-.03v-4.67c.02-1.41,1.16-2.53,2.57-2.53h6c5.09-.92,10.02-2.55,14.66-4.83l.1-.07c.17-.08.38,0,.46.17.08.17,0,.38-.17.46h0l-.1.04c-4.71,2.32-9.71,3.97-14.88,4.9H2.57c-1.02.01-1.85.84-1.87,1.86v4.67c0,1.04.83,1.89,1.87,1.9,0,0,0,0,0,0h6c5.19.93,10.22,2.58,14.94,4.9l.1.05c.17.08.25.28.17.45-.06.12-.18.2-.32.2h0Z"/>
                        <path id="Path_3" data-name="Path 3" class="cls-marketing" d="M8.57,15.82c-.19,0-.34-.15-.34-.34h0V6.38c0-.19.16-.35.35-.35s.35.16.35.35h0v9.1c0,.19-.15.34-.34.34,0,0,0,0-.01,0Z"/>
                        <path id="Path_4" data-name="Path 4" class="cls-marketing" d="M9.37,25.21h-3.16c-.75,0-1.41-.48-1.63-1.2l-2.03-8.48c-.04-.18.07-.36.24-.41.19-.04.37.07.42.25l2.03,8.45c.13.42.53.7.97.7h3.16c.25,0,.45-.2.44-.45,0-.17-.1-.32-.24-.4l-.53-.28c-.27-.15-.48-.4-.56-.7l-1.65-7.18c-.04-.19.08-.37.26-.41.18-.04.37.07.41.26,0,0,0,0,0,0l1.64,7.17c.04.1.11.18.21.23l.55.29c.56.29.78.97.49,1.53-.2.38-.59.62-1.01.61h0Z"/>
                        <path id="Path_5" data-name="Path 5" class="cls-marketing" d="M24.98,14.52c-.19.02-.37-.12-.39-.31-.02-.19.11-.36.3-.39,1.19-.45,1.96-1.62,1.91-2.89.08-1.3-.7-2.49-1.91-2.95-.18-.06-.28-.25-.22-.43.05-.17.23-.27.41-.23,1.52.53,2.51,2,2.42,3.61.1,1.61-.89,3.09-2.42,3.62l-.09-.03Z"/>
                        <path id="Path_6" data-name="Path 6" class="cls-marketing" d="M32.97,11.23h-4.37c-.19,0-.35-.16-.35-.35s.16-.35.35-.35h4.37c.19,0,.35.16.35.35s-.16.35-.35.35h0Z"/>
                        <path id="Path_7" data-name="Path 7" class="cls-marketing" d="M28.37,8.46c-.13,0-.25-.07-.31-.18-.08-.17-.02-.38.15-.47l3.98-2.1c.17-.08.38-.02.47.15.09.17.02.37-.15.46l-3.98,2.1c-.05.02-.11.04-.16.04Z"/>
                        <path id="Path_8" data-name="Path 8" class="cls-marketing" d="M32.35,16.11c-.06,0-.11-.01-.16-.04l-3.98-2.1c-.17-.09-.23-.3-.15-.47.09-.17.3-.23.46-.14,0,0,0,0,0,0l3.98,2.1c.17.08.24.29.16.46-.06.12-.18.2-.32.19Z"/>
                        <path id="Path_9" data-name="Path 9" class="cls-marketing" d="M10.1,37.34c-.19,0-.34-.15-.34-.34v-7.94h-2.97v7.94c0,.19-.16.35-.35.35-.19,0-.35-.16-.35-.35h0v-8.28c0-.19.15-.34.34-.34h3.66c.19,0,.34.15.34.34v8.28c0,.19-.15.34-.34.34h0Z"/>
                        <path id="Path_10" data-name="Path 10" class="cls-marketing" d="M16.65,37.34c-.19,0-.34-.15-.34-.34v-13.47h-2.97v13.47c0,.19-.16.35-.35.35s-.35-.16-.35-.35v-13.81c0-.19.15-.34.34-.34,0,0,0,0,0,0h3.65c.19,0,.35.15.35.34,0,0,0,0,0,0v13.81c0,.19-.15.34-.34.34h0Z"/>
                        <path id="Path_11" data-name="Path 11" class="cls-marketing" d="M23.21,37.34c-.19,0-.35-.15-.35-.34v-10.74h-2.97v10.74c0,.19-.16.35-.35.35-.19,0-.35-.16-.35-.35h0v-11.09c0-.19.15-.34.34-.34h3.66c.19,0,.34.15.34.34v11.09c0,.18-.15.34-.33.34Z"/>
                        <path id="Path_12" data-name="Path 12" class="cls-marketing" d="M29.76,37.34c-.19,0-.34-.15-.34-.34v-6.57h-2.97v6.56c0,.19-.16.35-.35.35s-.35-.16-.35-.35v-6.91c0-.19.15-.34.34-.34h3.66c.19,0,.34.15.34.34v6.91c0,.19-.15.34-.34.34Z"/>
                        <path id="Path_13" data-name="Path 13" class="cls-marketing" d="M36.31,37.34c-.19,0-.34-.15-.34-.34v-16.59h-2.97v16.59c0,.19-.16.35-.35.35-.19,0-.35-.16-.35-.35v-16.94c0-.19.15-.34.34-.34,0,0,0,0,0,0h3.65c.19,0,.35.15.35.34,0,0,0,0,0,0v16.94c0,.19-.15.34-.34.34Z"/>
                        <path id="Path_14" data-name="Path 14" class="cls-marketing" d="M42.87,37.34c-.19,0-.35-.15-.35-.34,0,0,0,0,0,0V9.27h-2.97v27.73c0,.19-.16.35-.35.35s-.35-.16-.35-.35V8.92c0-.19.15-.35.34-.35,0,0,0,0,0,0h3.66c.19,0,.34.15.34.34,0,0,0,0,0,0v28.07c0,.18-.15.34-.33.34Z"/>
                        <path id="Path_15" data-name="Path 15" class="cls-marketing" d="M44.45,37.34H4.86c-.19,0-.35-.16-.35-.35s.16-.35.35-.35h39.59c.19,0,.35.16.35.35s-.16.35-.35.35Z"/>
                        <path id="Path_1" data-name="Path 1" class="cls-marketing" d="M24.24,21.87h0c-.6,0-1.08-.49-1.08-1.08V1c.05-.61.59-1.05,1.19-1,.53.05.95.47,1,1v19.79c0,.6-.49,1.09-1.08,1.09,0,0-.01,0-.02,0ZM24.24.6c-.22,0-.41.17-.42.39,0,0,0,0,0,0v19.79c0,.22.18.4.4.4h0c.22,0,.4-.18.4-.4V1c0-.21-.17-.39-.38-.4Z"/>
                      </svg>
                </i>
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon">
                    <svg id="Layer_12" data-name="Layer 12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 387.86 386.04">
                        <defs>
                          <style>
                            .cls-admin {
                              fill: #fff;
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon">
                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 226.73 226.72">
                        <defs>
                          <style>
                            .cls-operations {
                              fill: #fff;
            ...
            <a href="{{ route('inbox')}}" class="menu-link">
                <i class="menu-icon">
                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34 27">
                        ...
                        <path id="Path" class="cls-inbox" d="M.72,2.98h0c0-1.25,1.01-2.27,2.26-2.28h28.04c1.26,0,2.27,1.02,2.28,2.28v21.04c0,1.26-1.02,2.27-2.28,2.28H2.98c-1.26,0-2.27-1.02-2.28-2.28h0l.02-21.04Z"/>
