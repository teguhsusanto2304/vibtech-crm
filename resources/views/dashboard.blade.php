...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <script src="../assets/js/app-calendar.js"></script>
          <!-- /Calendar & Modal -->
          <!-- Calendar Sidebar -->
          <div class="col app-calendar-sidebar" id="app-calendar-sidebar" style="margin-left: 20px;margin-top:20px;">
            <div class="card" style="background-color: #f5f6fa;">
                <div class="card-header">
                    <div class="panel-header">
                        <p>Date Selected: {{ date('d-M-Y') }}</p>
                    </div>
                </div>
                <div class="card-body">
                    <style>
...
.activity-item {
  background-color: #e0e0ff; /* Example color, adjust as needed */
  padding: 5px 10px;
  margin-bottom: 5px;
  border-radius: 3px;
}
.activity-item-onleave {
  background-color: #baeb0c; /* Example color, adjust as needed */
  padding: 5px 10px;
  margin-bottom: 5px;
  border-radius: 3px;
}
...
.activity-item-event {
  background-color: #7aec9e; /* Example color, adjust as needed */
  padding: 5px 10px;
  margin-bottom: 5px;
  border-radius: 3px;
}
.activity-item-ph {
  background-color: #f59870; /* Example color, adjust as needed */
  padding: 5px 10px;
  margin-bottom: 5px;
  border-radius: 3px;
  color: #fff;
  ...
  flex-direction: column; ">
                        <h4>Activities</h4>
                        <div class="activity-item">build the Dashboard module on CRM Project</div>
  <div class="activity-item">deployment CRM Project into R&D PC</div>

                        <h4>On Leave</h4>
                        <div class="activity-item-onleave">Annual leave on 2024</div>

                        <h4>Company Event</h4>
                        <div class="activity-item-event">Meeting with customer at 10 AM</div>

                        <h4>Public Holiday</h4>
                        <div class="activity-item-ph">Chinnesse New Year</div>
                    </div>
                </div>
            </div>
        </div>
