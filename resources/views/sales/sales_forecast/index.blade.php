        ...
        <!-- Custom Styles -->
            ...
            <div class="tab-pane fade show active" id="btn-text-alignment-preview" role="tabpanel"
                ...
                <div class="row gy-4 {{ $title == 'Job Requisition Form' ? 'equal-height-cards' : '' }}">
                    @can('create-sales-forecast')
                    <div class="col-12 col-md-4">
                        <div class="card text-center">
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">New Sales Forecast</h5>
                                
                                    <a href="{{ route('v1.sales-forecast.create') }}" class="btn btn_primary mt-auto">
                                        Create</a>
                   ...
                   @can('view-sales-forecast')
                    <div class="col-12 col-md-4">
                        <div class="card text-center">
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">Sales Forecast Review</h5>
                                <a href="{{ route('v1.sales-forecast.review')}}" class="btn btn_primary mt-auto">View</a>
                            </div>
                        </div>
                    </div>
                   @endcan
