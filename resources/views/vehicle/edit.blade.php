...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        @endif
        <form action="{{ route('v1.vehicles.update', $vehicle->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
        <div class="row">
        ...
        <div class="mb-3 col-md-10">
            ...
            @if($vehicle->path_image)
                <img src="{{ asset( $vehicle->path_image) }}" class="img-thumbnail mt-2" width="150">
            @endif
        </div>
        </div>
