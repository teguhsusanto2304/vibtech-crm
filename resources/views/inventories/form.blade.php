    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form class="row g-3"
                        action="{{  route('v1.inventory-management.store') }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="sku_no" name="sku_no" value="{{ old('sku_no') }}" required>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <a href="{{ route('v1.inventory-management')}}" class="btn btn-warning">Cancel</a>
                        </div>
                    </form>
