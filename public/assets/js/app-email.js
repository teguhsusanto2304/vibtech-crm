document.addEventListener("DOMContentLoaded", function () {
    {
            ...
            e =
                ...
                a.emailListItemInputs &&
                    a.emailListItemInputs.forEach((e) => {
                        e.addEventListener("click", (e) => {
                            e.stopPropagation();
                            var e = a.emailListItemInputs.filter(
                                    (e) => e.checked
                                ).length,
        ...
        if (
            (a.toggleBCC &&
                a.toggleBCC.addEventListener("click", () =>
                    e(".email-compose-bcc")
                ),
            a.toggleCC &&
                a.toggleCC.addEventListener("click", () =>
                    e(".email-compose-cc")
                ),
            ...
            a.refreshEmails.addEventListener("click", () => {
                Block.standard(l, {
                    backgroundColor:
                        "rgba(" +
                        window.Helpers.getCssVar("black-rgb") +
                        ", 0.1)",
                    svgSize: "0px",
                });
